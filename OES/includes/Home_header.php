                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <a href=""><img class="main-logo" 
                                src="img/oeslogo.png" alt="" /></a>
                                                ...
                                                <li class=""><a href="#" class="nav-link h4 si " >Home</a>
                                                </li>
                                                <li class="nav-item"><a href="#" class="nav-link h4 si">About</a>
                                                </li>
                                                <li class="nav-item"><a href="#" class="nav-link h4 si">Services</a>
                                                </li>
                                               
                                                <li class="nav-item"><a href="#" class="nav-link h4 si">Support</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
